...
- 所选Device Adapter/FlightLogic及Board物理映射组合变化；
...
当前值由FCCG build决定：`0x01/0x03/0x05/0x07`分别表示NONE、NONE+OneFace、NONE+SixFace、三者。
