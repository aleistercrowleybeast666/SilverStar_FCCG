 ...
 */
void SX1280HalWriteCommand(uint8_t instance,  RadioCommands_t opcode, uint8_t *buffer, uint16_t size );
 ...
 */
void SX1280HalReadCommand(uint8_t instance,  RadioCommands_t opcode, uint8_t *buffer, uint16_t size );
 ...
 */
void SX1280HalWriteRegisters(uint8_t instance,  uint16_t address, uint8_t *buffer, uint16_t size );
 ...
 */
void SX1280HalReadRegisters(uint8_t instance,  uint16_t address, uint8_t *buffer, uint16_t size );
 ...
 */
void SX1280HalWriteBuffer(uint8_t instance,  uint8_t offset, uint8_t *buffer, uint8_t size );
 ...
 */
void SX1280HalReadBuffer(uint8_t instance,  uint8_t offset, uint8_t *buffer, uint8_t size );
