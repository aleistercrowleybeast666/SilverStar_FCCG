...
This plugin owns only the `logging` protocol category and Profile flight_log.0_0. It changes build ownership and declarative metadata only; current wire/Record bytes remain unchanged.
